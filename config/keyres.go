...
func license() (*asset, error) {
	...
	info := bindataFileInfo{name: "LICENSE", size: 11358, mode: os.FileMode(0644), modTime: time.Unix(1586170427, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xcf, 0xc7, 0x74, 0x9b, 0x96, 0xf6, 0x3b, 0xd3, 0x1c, 0x3c, 0x42, 0xb5, 0xc4, 0x71, 0xbf, 0x75, 0x68, 0x14, 0x5, 0x3e, 0x84, 0x7c, 0x10, 0xf3, 0xeb, 0x0, 0x34, 0x17, 0xbc, 0x52, 0x3d, 0x30}}
	return a, nil
}
